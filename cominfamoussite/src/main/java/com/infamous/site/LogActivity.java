...
import com.infamous.site.exception.*;
import com.infamous.site.Utils.CleanAllTask;
import com.infamous.site.Utils.CleanUncompressedTask;
...
public class LogActivity extends SherlockFragmentActivity {
	...
	private void showRunningDialog(){
		dialog = ProgressDialog.show(LogActivity.this, "", getResources().getString(R.string.working));
	}
